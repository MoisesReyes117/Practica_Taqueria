...
public class FrmLlenadoOrden extends Stage {
    ...
    private ComboBox<BebidasDAO> cbxBebida;
    ...
    private void CrearGUI() {
        ...
        cbxBebida.setItems(new BebidasDAO().seeAllBebidas());
        BebidasDAO objBe = new BebidasDAO();
    ...
    private void guardarBebida() {
        ...
        BebidasDAO objTemp1 = cbxBebida.getValue();
